  ...
  CurrentHouseholdBloc() : super(CurrentHouseholdInitial()) {
    on<SetCurrentHousehold>((event, emit) async {
      ...
      try {
        ...
        await prefs.setString('currentHousehold', json.encode({
          'id': event.household.id,
          'name': event.household.name,
          'inviteCode': event.household.inviteCode,
          'createdBy': event.household.createdBy,
        }));
      ...
      try {
        ...
        if (householdJson != null && householdJson.isNotEmpty) {
          ...
          final household = Household(
            ...
            inviteCode: householdMap['inviteCode'],
            createdBy: householdMap['createdBy'],
          );
